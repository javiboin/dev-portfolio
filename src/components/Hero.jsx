    ...
    return (
        <section className="hero" id="inicio">
            <div className="hero-content">
                <span className="hero-subtitle">FULLSTACK DEVELOPER // SYSTEM ARCHITECT</span>
                <h1 className="hero-title">
                    Hola, soy
                    <span>Javier A. Oyarzo</span>
                </h1>
                <p className="hero-desc">
                    Diseñador y desarrollador de software de alta fidelidad. Construyo sistemas 
                    digitales con arquitecturas eficientes, estética minimalista y rendimiento óptimo.
                </p>
